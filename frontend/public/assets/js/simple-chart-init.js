// Simple chart initialization functions for the dashboard
(function() {
  'use strict';
  ...
  // Initialize donut charts using ECharts directly
  window.initDonutChart = function(selector) {
    ...
    let chart = echarts.init(document.querySelector(selector));
  ...
  // Initialize orders chart using ECharts directly
